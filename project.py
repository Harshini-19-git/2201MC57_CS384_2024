...
import pandas as pd
import numpy as np
ip_1 = pd.read_csv("ip1.csv", header=0)
ip_2 = pd.read_csv("ip2.csv", header=0)
ip_3 = pd.read_csv("ip3.csv", header=0)
ip_4 = pd.read_csv("ip4.csv", header=0)
ip_1.head()
